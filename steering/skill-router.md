...
| `ai-agent-builder` | AI agent: chatbot, LangGraph, specialist/intent, tools, knowledge, guardrails, conversation lifecycle |
...
3. Kalau task melibatkan AI agent / chatbot / LangGraph / specialist → activate `ai-agent-builder`
4. Kalau task melibatkan deployment/infra → activate `argocd`
5. Kalau task melibatkan system design/architecture → activate `erd`
6. Kalau task melibatkan product requirement → activate `prd`
7. Kalau task melibatkan lebih dari 1 domain → activate semua yang relevan
8. `nextjs-core` TIDAK berdiri sendiri — selalu diaktifkan bersama minimal satu track Next.js
9. Selalu baca SKILL.md dan references yang relevan sebelum mulai kerja
